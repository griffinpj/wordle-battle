// Curated 5-letter answer list + valid guess set.
const ANSWERS = [
  ...
  "drift","flame","glint","heron","ivory","jolly","kneel","mango","ninja","onset",
  "prize","quirk","ravel","spire","trout","ultra","vivid","waltz","xenon","yacht",
  "zebra"
];
...
module.exports = { ANSWERS, randomAnswer, isValidGuess, score };
